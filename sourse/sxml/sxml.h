...
typedef void (*AddTockenCallBack)(const sxmltok_t*, void* );

sxmlerr_t sxml_parse(sxml_t *parser, const char *buffer, unsigned bufferlen, sxmltok_t* tokens, unsigned num_tokens, AddTockenCallBack addTockenCallBack, void* addTockenCallBackData);
